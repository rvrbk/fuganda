...
class SocialAuthControllerTest extends TestCase
{
    ...
    {
        config()->set('app.url', 'https://mycanopy.verbeek.ug');
        config()->set('sanctum.stateful', ['localhost', 'localhost:8000', 'mycanopy.verbeek.ug']);
        ...
        $state = base64_encode(json_encode([
            'role' => 'buyer',
            'nonce' => 'crosshost123',
            'origin' => 'http://mycanopy.verbeek.ug.test',
        ], JSON_THROW_ON_ERROR));
